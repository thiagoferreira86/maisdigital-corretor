...
$posts = Post::paginate($page,$quantity,$query,' id DESC');
$count = Post::count($query,"OTIMIZEposts");
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row">
								     <?php
                                        if(count($posts) ==0){
                                            echo '<div class="col-md-12"><p style="text-align:center;">Nenhum Post encontrado.</p></div>';
                                        } else {
                                            foreach($posts as $v){ 
                                    ?>
                                	<div class="col-xl-4">
                                        ...
                                        <!--begin::Body-->
                                            <div class="card-body posts">
                                                <a href="<?=DASHBOARD?>capacitacao/post/<?=$v->url?>"><img src="<?=BASE?>imagens/<?=$v->imagem?>"></a>
                                                <h2><a href="<?=DASHBOARD?>capacitacao/post/<?=$v->url?>"><?=$v->titulo?></a></h2>
                                                <p><a href="<?=DASHBOARD?>capacitacao/post/<?=$v->url?>"><?=$v->subtitulo?></a></p>
                                            </div>
                                            <!--end::Body-->
                                        </div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                    <div class="d-flex flex-wrap py-2 mr-3">
                                                        <?php
                                                            ...
                                                            if($pg > 0){ ?>
                                                                <a href="<?=DASHBOARD?>tutoriais/digital-news/<?=$pg?>" class="btn btn-icon btn-sm btn-light-danger mr-2 my-1"><i class="ki ki-bold-arrow-back icon-xs"></i></a>
                                                            <? } else { ?>
                                                            ...
                                                            <? }
                                                                ...
                                                                if($pg == ($i_pg-1)){ ?>
                                                                    <? if($i_pg != 1){ ?>
                                                                         <a href="<?=DASHBOARD?>tutoriais/digital-news/<?=$i_pg-1?>" class="btn btn-icon btn-sm border-0 btn-hover-danger mr-2 my-1"><?=$i_pg-1?></a>
                                                                    <? } ?>
                                                                    <a href="javascript:void(0)" class="btn btn-icon btn-sm border-0 btn-hover-danger active mr-2 my-1"><?=$i_pg?></a>
                                                            <?  } else if($i_pg-1 < $pages){
                                                                    $i_pg2 = $i_pg-1; ?>

                                                                     <a href="<?=DASHBOARD?>tutoriais/digital-news/<?=$i_pg2+1?>" class="btn btn-icon btn-sm border-0 btn-hover-danger mr-2 my-1"><?=$i_pg?></a>
                                                            <?  }
                                                            }
                                                            if(($pg+2) < $quant_pg){ ?>
                                                                <a href="<?=DASHBOARD?>tutoriais/digital-news/<?=$pg+2?>" class="btn btn-icon btn-sm btn-light-danger mr-2 my-1"><i class="ki ki-bold-arrow-next icon-xs"></i></a>
                                                        <? } else { ?>

						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">E-mail Marketing - Campanhas</h5>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Gerenciamento de Campanhas
											<span class="d-block text-muted pt-2 font-size-sm">Edite e exclua Campanhas</span></h3>
										</div>
										<div class="card-toolbar">
											<!--begin::Button-->
											<a href="email-marketing/campanha" class="btn btn-mapfre font-weight-bolder">
		...
		<script>
		    $(document).ready(function() {
                $('#tabela').DataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": "dashboard/email-marketing/listaCampanhas",
                    ...
                    cancelButtonText: "Não, cancelar!",
                        ...
                        if (result.value) {
                            $.ajax({
                                type: "POST",
                                dataType: "json",
                                url: "dashboard/email-marketing/excluiCampanha",

                                ...
                                <div class="tab-content mt-5" id="myTabContent">
                                    <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel" aria-labelledby="kt_tab_pane_2">
        								...
        								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
        									<!--begin::Card-->
        									<div class="card card-custom gutter-b card-stretch" style="border: 1px solid #c1c1c1;">
        										<!--begin::Body-->
        										<div class="card-body text-center pt-4">
        											<!--begin::User-->
        											<div class="mt-7" style="height:200px; overflow:hidden;">
        												<div class="symbol symbol-circle symbol-lg-90">
        													<a href="https://mapfre.otimize.online/<?=$t->pasta?>/<?=$t->referencia?>" target="_blank"><img src="<?=BASE?>templates/<?=$t->pasta?>/imagens/<?=$t->imagem?>" style="width:100%;" alt="image"></a>
        												</div>
        											</div>
        											<!--end::User-->
        											<!--begin::Name-->

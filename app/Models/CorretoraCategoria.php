...
class CorretoraCategoria extends ActiveRecord {
    ...
    public function getTable() {
        return 'MDM_corretoras_categorias';
    }
	...
	public static function find($id = 0, $conditions = null, $order = 'id DESC') {
		...
		$result = self::load('MDM_corretoras_categorias','CorretoraCategoria',$conditions,$order);
